...
{  private ServerThread clients[] = new ServerThread[50]; //Anzahl der maximal m�glichen Clients - schmiert bei 20+ schon ab wegen diversen Timeouts
   ...
   //Client kann �ber die Thread-Id gesucht werden
   ...
   {  
	  //Server sucht den zu entfernenden Client aus dem Array �ber die ID
      ...
      {  
         ...
         if (pos < clientCount-1)
        	 //Array aus Clients wird defragmentiert wegen L�cken und so...
